...
Функция ЗаполнитьВариантыВыполненияЗадачи(ЗаписьXML, Объект)
	...
	ИначеЕсли Объект.ТочкаМаршрута = БизнесПроцессы.Утверждение.ТочкиМаршрута.Утвердить Тогда
		...
		ДобавитьВариантИсполнения(
			ЗаписьXML, Объект, 1,
			НСтр("ru = 'Утверждено'; en = 'Confirmed'"), НСтр("ru = 'Утверждено'; en = 'Confirmed'"), "ExecutedPositive");

		ДобавитьВариантИсполнения(
			ЗаписьXML, Объект, 2,
			НСтр("ru = 'Не утверждено'; en = 'Not confirmed'"), НСтр("ru = 'Не утверждено'; en = 'Not confirmed'"), "ExecutedNegative");
	...
	ИначеЕсли Объект.ТочкаМаршрута = БизнесПроцессы.Утверждение.ТочкиМаршрута.Ознакомиться Тогда
		...
		Иначе
			...
			ДобавитьВариантИсполнения(
				ЗаписьXML, Объект, 1,
				НСтр("ru = 'Завершить утверждение'; en = 'Finish confirmation'"), НСтр("ru = 'Завершить'; en = 'Finish'"), "ExecutedPositive");

			ДобавитьВариантИсполнения(
				ЗаписьXML, Объект, 2, 
				НСтр("ru = 'Повторить утверждение'; en = 'Repeat confirmation'"), НСтр("ru = 'Повторить'; en = 'Repeat'"), "ExecutedNegative");
	...
	ИначеЕсли Объект.ТочкаМаршрута = БизнесПроцессы.Исполнение.ТочкиМаршрута.Проверить Тогда
		...
		ДобавитьВариантИсполнения(
			ЗаписьXML, Объект, 1,
			НСтр("ru = 'Завершить исполнение'; en = 'Finish performance'"), НСтр("ru = 'Завершить'; en = 'Finish'"), "ExecutedPositive");
